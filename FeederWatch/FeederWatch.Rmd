...
title: "R Notebook"
---
I chose dataset 3 - Bird FeederWatch data

```{r}
libs <- c("tidyverse", "maps", "Amelia", "ggrepe", "usmap", "RColorBrewer")
...
region_data <- data.frame(
  subnational1_code = c("US-KY", "US-LA", "US-MA", "US-MD", "US-ME", "US-MI", "US-MN", "US-MO", "US-MS", "US-MT"),
  state = c("Kentucky", "Louisiana", "Massachusetts", "Maryland", "Maine", "Michigan", "Minnesota", "Missouri", "Mississippi", "Montana"),
  median_value = c(0.0000, 0.0000, 0.0000, 0.0000, 0.0010, 0.0010, 0.0010, 0.0000, 0.0000, 0.0010)
)

snow_depth_plot <- plot_usmap(data = region_data, values = "median_value", color = "white") +
  scale_fill_gradient(low = "white", high = "blue", na.value = "gray", guide = "legend") +
